...
// (async () => {
//   console.log('sessionLogin', await sessionLogin({ email: 'test@test.test', password: 'PasswordAbc123' }));
//   console.log('session', await getSessionBySessionId('1024MspWptsTeiTHEH_LKLQsQQ'));
// })().catch(console.error);
